...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'sales.create.create': { roles: ['owner', 'sales-manager'], key: 'sales', tenantPath: [], userPath: [] },
  'inventory.update.update': { roles: ['owner', 'sales-manager'], key: 'inventory', tenantPath: [], userPath: [] },
  'customer.complaint.create': {
    roles: ['owner', 'sales-manager', 'sales-representative'],
    key: 'customer',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['owner', 'sales-manager', 'sales-representative'];
