...
import { getSalesChannelById } from 'apiSdk/sales-channels';
import { SalesChannelInterface } from 'interfaces/sales-channel';
import { SalesActivityListPage } from 'pages/sales-activities';

function SalesChannelViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('sales_channel', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/sales-channels/edit/${id}`} passHref legacyBehavior>
                    <Button
