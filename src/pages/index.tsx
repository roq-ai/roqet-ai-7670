...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ROQet AI`}</title>

        <meta
          name="description"
          content="Experience ROQet AI - Your AI powered sales assistant. We empower sales teams to send personalized messages across multiple channels, seamlessly."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1684369585053-2b35888b3ae8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSXxlbnwwfHx8fDE2OTcyMDIxMjh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience ROQet AI - Your AI powered sales assistant. We empower sales teams to send personalized messages across multiple channels, seamlessly.`}
            </Text>
            <Box
