...
import { DefaultMessageVariablesListPage } from 'pages/default-message-variables';
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Message Template Details',
              isCurrent: true,
            },
          ]}
        />
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('message_template', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/message-templates/edit/${id}`} passHref legacyBehavior>
                    <Button
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6} p={'18px'}>
              <DefaultMessageVariablesListPage
                filters={{ message_template_id: id }}
                hidePagination={true}
