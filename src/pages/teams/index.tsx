...
export function TeamListPage(props: TeamListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTeams({
        relations: ['user', 'message_template.count', 'sales_channel.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('message_template', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.message_template,
        }
      : null,
    hasAccess('sales_channel', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.sales_channel,
        }
      : null,
